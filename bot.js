...
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'Demon')) {
    if (!devs.includes(message.author.id)) return; 
...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith(`<@${client.user.id}>`)) {
        ebnklb.channel.send('Hey Im **Sliver bot !**  A Nice Bot Developed By:`Demons`')
...
var v1 = new Discord.RichEmbed()
  ...
  v1.setFooter("# | Demon TeaM |")
var heroo = new Discord.RichEmbed()
.setColor('#6a109d')
.setTimestamp(new Date())
.setThumbnail(client.user.avatarURL)
.setTitle('Demon Bot Info')
...
client.on('message', message => { 
    ...
    .setFooter(`Demon Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
